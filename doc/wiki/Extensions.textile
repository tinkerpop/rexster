[[http://dvice.com/pics/aibooldpeople.jpg|width=180px]]
...
Rexster is packaged with the [[Gremlin Extension|Using-Gremlin]] which allows users to execute ad-hoc computations on the graph backend.  The "Rexster Kibbles":http://rexster-kibbles.tinkerpop.com project contains additional Extensions that can easily plug-in to Rexster.
