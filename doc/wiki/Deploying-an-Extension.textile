...
At this point, Rexster is ready to start serving the Sample Kibbles.  [[Start Rexster|Getting Started]] and access @http://localhost:8182/graphs/tinkergraph@ being sure to set the @Accept@ header with the @application/vnd.rexster+json@ [[Rexster Mime Type|Rexster Mime Types]]:
