...
| vertices     | @/graphs/<graph>/vertices/<id>/out@                           | get the adjacency out vertices of vertex @<id>@                                                                       |
| vertices     | @/graphs/<graph>/vertices/<id>/in@                            | get the adjacency in vertices of vertex @<id>@                                                                        |
| vertices     | @/graphs/<graph>/vertices/<id>/both@                          | get the both adjacency in and out vertices of vertex @<id>@                                                           |
| edges        | @/graphs/<graph>/vertices/<id>/<dir>?_label=written_by@       | get the adjacency vertices of @<id>@ with edge label equal to "written_by" (value may also be a comma separated list) |
