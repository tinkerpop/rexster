...
Rexster JavaDoc: "2.2.0":http://tinkerpop.com/docs/javadocs/rexster/2.2.0/
Older JavaDocs (2.x): "2.1.0":http://tinkerpop.com/docs/javadocs/rexster/2.1.0/ - "2.0.0":http://tinkerpop.com/docs/javadocs/rexster/2.0.0/
For previous wikidocs, use the following URL schema: "http://tinkerpop.com/docs/wikidocs/rexster/${version}/Home.html":http://tinkerpop.com/docs/wikidocs/rexster/${version}/Home.html
...
* Rexster Clients
  ...
  ** "rexster-ruby":http://github.com/mavenik/rexster-ruby
* Conclusion
  ** [[Troubleshooting]]
  ** [[Acknowledgments]]
  ** [[Release Notes]]
