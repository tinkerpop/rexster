...
| RexsterResourceContext | A container for the @UriInfo@, @HttpServletRequest@, @ExtensionMethod@, @RexsterApplicationGraph@ and a @JSONObject@ which is the [[request object|Mapping a URI to JSON]] passed to Rexster |
