...
| RexsterResourceContext | A container for the @UriInfo@, @HttpServletRequest@, @ExtensionMethod@, @RexsterApplicationGraph@ and two request objects: one that is [[mapped|Mapping a URI to JSON]] to JSON and one that just contains the raw values passed to Rexster |
