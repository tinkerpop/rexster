...
Getting results with data types attached is accomplished through the @show_types@ parameter.  This value is set to @false@ by default, but when set to @true@ will wrap property results in a JSON object construct showing data type and the value.
