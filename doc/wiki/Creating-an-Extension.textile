...
By annotating the method and its parameters, an API is created. Next, resolve @http://localhost:8182/mygraph/ex/ping?reply=ping-a-ling@ and what is returned is:
