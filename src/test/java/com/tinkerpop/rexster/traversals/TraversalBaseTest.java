...
public abstract class TraversalBaseTest {
    ...
    protected RexsterResourceContext createStandardContext(final Map<String, String> parameterMap) {
        ...
        return createContext(new RexsterApplicationGraph("mock", mockGraph), new JSONObject(), new JSONObject(), mockCache, request, uriInfo);
    }

    protected RexsterResourceContext createContext(RexsterApplicationGraph appGraph, JSONObject requestObject, JSONObject resultObject, ResultObjectCache cache, HttpServletRequest request, UriInfo uriInfo) {
