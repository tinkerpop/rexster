...
* Gremlin Extension converts all parameters passed to it that are not part of what is expected by the extension itself to bindings to the Gremlin script engine.
