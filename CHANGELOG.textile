...
* Added two custom Rexster mime types: @application/vnd.rexster+json@ and @application/vnd.rexster.typed+json@.
** The @rexster.showTypes@ general parameter does not exist anymore and is replaced by @application/vnd.rexster.typed+json@.
