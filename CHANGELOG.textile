...
* The @_limit@ query string argument for vertex queries is split into @_skip@ and @_take@ to better match the new limit API in Blueprints.
...
* Allow specification of multiple Script Engine initialization files in @rexster.xml@.
