...
@BenchmarkMethodChart(filePrefix = "read-all-edges")
@BenchmarkHistoryChart(labelWith = LabelType.CUSTOM_KEY, maxRuns = 20, filePrefix = "hx-read-all-edges")
public class ScenarioReadAllEdgesTest extends AbstractRexsterPerformanceTest {
